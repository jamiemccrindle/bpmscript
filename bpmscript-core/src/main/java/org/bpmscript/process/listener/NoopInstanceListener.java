...
/**
 * An instance listener that does nothing. Useful for sub classing if 
 * only one of the listener methods is needed.
 */
public class NoopInstanceListener implements IInstanceListener {
