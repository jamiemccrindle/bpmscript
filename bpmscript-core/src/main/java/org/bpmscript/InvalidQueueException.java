...
/**
 * Thrown if the process can't find a valid queue to send a message to
 */
public class InvalidQueueException extends Exception {

    private static final long serialVersionUID = 6386925668573201528L;
    ...
    public InvalidQueueException(Throwable cause) {
        super(cause);
    }
