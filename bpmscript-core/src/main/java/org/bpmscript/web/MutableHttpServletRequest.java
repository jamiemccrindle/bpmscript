...
public class MutableHttpServletRequest implements HttpServletRequest, Serializable {
    ...
    public MutableHttpServletRequest(Map<String, String[]> params) {
    ...
    public Hashtable<String, Vector<String>> getHeaders() {
        return headers;
    }

    public void setHeaders(Hashtable<String, Vector<String>> headers) {
    ...
    public void setCookies(SerializableCookie[] cookies) {
