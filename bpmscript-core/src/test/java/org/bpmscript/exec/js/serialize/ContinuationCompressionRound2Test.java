...
public class ContinuationCompressionRound2Test extends TestCase {
    ...
    public void testWriting() throws Exception {
        ...
        try {
            ...
            continuation = e.getContinuation();
            MonitoringScriptableOutputStream scriptableOutputStream = 
                new MonitoringScriptableOutputStream(
                        m2, 
                        ScriptableObject.getTopLevelScope(continuation));
            scriptableOutputStream.writeObject(continuation);
            bytes = out.toByteArray();
