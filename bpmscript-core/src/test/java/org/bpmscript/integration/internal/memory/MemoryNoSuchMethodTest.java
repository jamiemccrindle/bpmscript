 ...
 */
public class MemoryNoSuchMethodTest extends TestCase {
	...
	public void testChannel() throws Exception {
		...
		integrationTestSupport.execute(new ITestCallback<IServiceLookup>() {
            ...
            public void execute(IServiceLookup services) throws Exception {
                ...
                processManager.createDefinition("id", new JavascriptProcessDefinition("test", StreamService.DEFAULT_INSTANCE.getResourceAsString("/org/bpmscript/integration/memory/nosuchmethod.js")));
                ...
                IBenchmarkPrinter.STDOUT.print(new Benchmark().execute(total, new IBenchmarkCallback() {
                    public void execute(int count) throws Exception {
                        ...
                        message.setArgs(null, "test", "runit", new Object[] {"Hello World!"});
